  ...
  <div class="max-w-4xl mx-auto">
    ...
    <template v-if="data">
      <div class="card mb-6">
        ...
        <div v-if="data.checkpoints.length === 0" class="text-body-sm text-text-soft">
      ...
      <div class="card mb-6">
        ...
        <div class="flex items-center gap-6 mb-4">
          <div class="flex items-center gap-2">
            ...
            >Všechny ({{ data.stats.total }})</button>
            ...
            >Obodované ({{ data.stats.scored }})</button>
            ...
            >Neobodované ({{ data.stats.remaining }})</button>
          </div>
        </div>
